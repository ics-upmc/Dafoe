...
public class SyntexDocument {
	...
	/** Dafoe instance */
	private IDocument dafoeDoc = null;
	...
	/** Get the associated Dafoe document.
	 * @return A Dafoe document.
	 */
	public IDocument getDafoeDocument() {
		if(dafoeDoc == null) {
			dafoeDoc = new DocumentImpl();
			dafoeDoc.setName(getDocumentLabel());
		}
		return dafoeDoc;
	}
	...
	public String buildBasicSeqId(int syntexSeqId) {
		return SyntexDocument.buildBasicSeqId(documentId, syntexSeqId);
	}

	public static String buildBasicSeqId(String documentId, int syntexSeqId) {
		if(syntexSeqId > 9999) {
			getLogger().severe("Warning, syntex seq number superior to 9999. Sentence Id will be incorrect.");
		}
