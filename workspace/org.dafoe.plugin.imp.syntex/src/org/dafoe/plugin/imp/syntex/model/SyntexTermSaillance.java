...
public class SyntexTermSaillance {
	...
	public SyntexTermSaillance(String[] splittedLine, SyntexTerm term) {
		Logger log = Logger.getLogger(SyntexResourceTerminological.class.getName());
		try {
	 ...
	 * @return dafoeSaillance
	 */
	public ITermSaillance getDafoeTermSaillance() {
		...
		dafoeSaillance.setHeadProductivity(getProdT());
		dafoeSaillance.setModifierNeighborSize(getNbvoisterm());
		dafoeSaillance.setModifierProductivity(getProdE());
		dafoeSaillance.setNbVar(getNbvar());
		
		// Not accessible in Syntex
		dafoeSaillance.setTfIdf(0);		
		dafoeSaillance.setPositionWeight(0);
		dafoeSaillance.setTypographicalWeight(0);
