...
//	private SyntexTermSaillance saillance = null;
	...
	public ITerm getDafoeTerm() {
		ITerm dafoeTerm = new TermImpl();
		dafoeTerm.setLabel(getLemme());
		//VT: use type-safe approach
		dafoeTerm.setState(TERMINO_OBJECT_STATE.STUDIED);
		dafoeTerm.setLinguisticStatus(LINGUISTIC_STATUS.INDIFFERENTIATED);
		return dafoeTerm;
	}
