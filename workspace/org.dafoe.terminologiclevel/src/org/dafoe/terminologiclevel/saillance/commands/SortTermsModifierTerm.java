...
public class SortTermsModifierTerm extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		viewPart.getTableTermViewer().setSorter(new TermSaillanceSorter(2));

		viewPart.getTableTermViewer().getTable().setSortColumn(
				viewPart.getTableTermViewer().getTable().getColumn(2));
