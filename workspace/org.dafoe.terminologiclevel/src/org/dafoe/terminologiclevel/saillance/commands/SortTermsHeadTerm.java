...
public class SortTermsHeadTerm extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		viewPart.getTableTermViewer().setSorter(new TermSaillanceSorter(1));

		viewPart.getTableTermViewer().getTable().setSortColumn(
				viewPart.getTableTermViewer().getTable().getColumn(1));
