...
public class SortTermsAlphabetic extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		viewPart.getTableTermViewer().setSorter(new TermSaillanceSorter(0));

		viewPart.getTableTermViewer().getTable().setSortColumn(
				viewPart.getTableTermViewer().getTable().getColumn(0));
