...
public class TerminologicRelationModel {
	...
	public static List <TerminologicRelationModel> createTerminologicRelationData(){
		try {
			...
			org.dafoe.terminologiclevel.Activator.getDefault().dafoeSession.createCriteria(TermRelationImpl.class).list();
			return data;
		} catch (Exception e) {
			e.printStackTrace();
			return new ArrayList<TerminologicRelationModel>();
		}
	}
