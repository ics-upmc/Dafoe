...
public class ChoixClasse extends TitleAreaDialog {

	public ChoixClasse(Shell parentShell,IOntology onto) {
		super(parentShell);
		ontology=onto;
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		setMessage(Messages.getString("ChoixClasse.ChoixDomaine"));  //$NON-NLS-1$
		setTitle(Messages.getString("ChoixClasse.DomainePossible"));  //$NON-NLS-1$
		...
		container.setLayoutData(new GridData(GridData.FILL_BOTH));
		{
			...
			lblClassName.setText(Messages.getString("ChoixClasse.ChoisissezLaClasse"));  //$NON-NLS-1$
		}
		{
	...
	void LoadClasses(Tree tree) {
		...
		rootit.setText(Messages.getString("ChoixClasse.Rien")); //$NON-NLS-1$
