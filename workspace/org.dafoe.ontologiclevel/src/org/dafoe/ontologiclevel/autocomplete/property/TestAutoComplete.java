...
public class TestAutoComplete {
	...
	private static List<IProperty> props = new ArrayList<IProperty>();

	private static Composite composite = null;
	
	public static String ID = "net.sf.swtaddons.tests.UITestView";
	
	private static AutocompletePropertySelector auto;
	...
	public static List<IProperty> getAllProperties() throws HibernateException{

		Session hSession = getDafoeSession();

		Transaction tx = hSession.beginTransaction();

		props =  hSession.createCriteria(ObjectPropertyImpl.class).list();
	...
	public static void createContents(Shell shell){
		...
		auto = new AutocompletePropertySelector(text2, props);
		...
		text2.addKeyListener(new KeyListener(){
			...
			public void keyPressed(KeyEvent e) {
				if (e.keyCode == SWT.CR){
					...
					System.out.println(auto.getPropertyFromSelectedLabel(text2.getText()));
