package org.dafoe.plugin.load.corpus.yatea.main;
...
import org.dafoe.plugin.load.corpus.yatea.model.ImportYATEA;
...
/** YateaLoaderResource for Dafoe.
 * @author <a href="mailto:teguiak@gmail.com">Henry Valéry TEGUIAK</a>
 */
public class YateaLoaderResource extends AbstractTerminoImportationWidget {
	...
	public String getDescription() {
		...
		return "This plug-in will import data from Yatea.";
	}
			           ...
			           public void run(){
			     		  ...
			     		  if (dir != null) {
			     	          // Set the text box to the new selection
			     	        	...
			     	        	ImportYATEA imp= new ImportYATEA();
			     	        	File fDirectory= new File(dir);
			     	        	//File fileTerms= Services.findYateaFileTerms(fDirectory);
			     	            System.out.println("dir= "+fDirectory.getAbsolutePath());
			     	        	try {
									imp.initConnection(fDirectory);
									imp.importData();
								} catch (Exception e) {
