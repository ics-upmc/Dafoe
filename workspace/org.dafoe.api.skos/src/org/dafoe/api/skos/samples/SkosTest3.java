 ...
 */
public class SkosTest3 {

	public static void main(String[] args) {
		SKOSModel.createModel();
		File f = new File("d:/ex2.rdf");
		...
		System.out.println("**************************************************************");
		System.out.println("Broaders of http://purl.org/ontology/mo/mit#Reeds");
		System.out.println("**************************************************************");
	
		SKOSConcept myConcept;
		
		myConcept = SKOSModel.getConcept("http://purl.org/ontology/mo/mit#Reeds");
		...
		System.out.println("**************************************************************");
		System.out.println("prefLabel of http://purl.org/ontology/mo/mit#Wind_instruments");
		System.out.println("**************************************************************");
