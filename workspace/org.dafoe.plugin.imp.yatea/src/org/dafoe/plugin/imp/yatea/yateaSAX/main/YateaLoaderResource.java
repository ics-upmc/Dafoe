package org.dafoe.plugin.imp.yatea.yateaSAX.main;
...
import org.dafoe.plugin.imp.yatea.yateaSAX.adaptater.Services;
			           ...
			           public void run(){
			     		  ...
			     		  if (dir != null) {
			     	          // Set the text box to the new selection
			     	        	...
			     	        	File fileTerms= Services.findYateaFileTerms(new File(dir));
			     	            File fileSent= Services.findYateaFileSentences(new File(dir));
			     	            
			     	            imp.importYateaResources(txtResourceName.getText(), fileTerms, fileSent);
			     	        }
			           }
			        }
			     );
