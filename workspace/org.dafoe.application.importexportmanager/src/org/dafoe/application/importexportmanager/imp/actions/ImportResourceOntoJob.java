 ...
 */
public class ImportResourceOntoJob extends Action implements
	...
	public ImportResourceOntoJob() {
		this(null);
	}


	public ImportResourceOntoJob(AbstractResourceImportationWidget resource) {
		...
		Job job = new Job("Import") {
			protected org.eclipse.core.runtime.IStatus run(
				...
				try {
							   ...
							   ImportResourceOntoJob.this.sleep(PAUSE_TIMER);
