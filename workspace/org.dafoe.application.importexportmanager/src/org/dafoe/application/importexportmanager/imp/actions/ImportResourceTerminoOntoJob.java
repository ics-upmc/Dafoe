 ...
 */
public class ImportResourceTerminoOntoJob extends Action implements
	...
	public ImportResourceTerminoOntoJob() {
		this(null);
	}
	
	public ImportResourceTerminoOntoJob(AbstractResourceImportationWidget resource) {
		...
		Job job = new Job("Import") {
			protected org.eclipse.core.runtime.IStatus run(
				...
				try {
							   ...
							   ImportResourceTerminoOntoJob.this.sleep(PAUSE_TIMER);
