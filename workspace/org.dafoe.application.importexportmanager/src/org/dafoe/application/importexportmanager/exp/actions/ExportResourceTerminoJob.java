 ...
 */
public class ExportResourceTerminoJob extends Action implements
	...
	public ExportResourceTerminoJob() {
		this(null);
	}

	

	public ExportResourceTerminoJob(AbstractResourceExportationWidget resource) {
		...
		Job job = new Job("Export") {
			protected org.eclipse.core.runtime.IStatus run(
				...
				try {
							   ...
							   ExportResourceTerminoJob.this.sleep(PAUSE_TIMER);
			            	   //resource.exportData();//.initConnection(filesDirectory);
