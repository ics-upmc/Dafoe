...
/**
 * The Class ImportResourceTerminoOntoAction.
 * 
 * @author <a href="mailto:teguiak@gmail.com">Henry Valéry TEGUIAK</a>
 */
public class ExportResourceTerminoOntoJob extends Action implements
	...
	public ExportResourceTerminoOntoJob() {
		this(null);
	}



	public ExportResourceTerminoOntoJob(AbstractResourceExportationWidget resource) {
		...
		Job job = new Job("Export") {
			...
			protected org.eclipse.core.runtime.IStatus run(
				...
				try {
							   ...
							   ExportResourceTerminoOntoJob.this.sleep(PAUSE_TIMER);
			            	   //resource.exportData();
