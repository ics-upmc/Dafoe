 ...
 *******************************************************************************/
package org.dafoe.application.presentations.sideWinder;
...
import org.dafoe.application.presentations.wrappedTabs.ProxyControl;
...
public class SideWinderItemViewPresentation extends StackPresentation {
	...
	public void layout() {
		...
		titleArea.setBackground(titleArea.getDisplay().getSystemColor(SWT.COLOR_RED));
