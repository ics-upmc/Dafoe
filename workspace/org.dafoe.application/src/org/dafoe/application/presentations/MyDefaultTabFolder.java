...
public class MyDefaultTabFolder extends AbstractTabFolder {
	...
	private static MyDefaultTabFolderColors defaultColors = new MyDefaultTabFolderColors();

	private MyDefaultTabFolderColors[] activeShellColors = { defaultColors,
			defaultColors, defaultColors };
	private MyDefaultTabFolderColors[] inactiveShellColors = { defaultColors,
			defaultColors, defaultColors };
	 ...
	 * @param allowMax
	 */
	public MyDefaultTabFolder(Composite parent, int flags, boolean allowMin,
			boolean allowMax) {
		...
		// Initialize view menu dropdown
		{
			...
			actualToolBar.getAccessible().addAccessibleListener(
	 ...
	 * 
	 * @see
	 * org.eclipse.ui.internal.presentations.util.AbstractTabFolder#getItemCount
	 * ()
	 */
	 ...
	 * 
	 * @see
	 * org.eclipse.ui.internal.presentations.util.AbstractTabFolder#getControl()
	 */
	...
	public void setSelectedInfo(PartInfo info) {
		...
		if (!Util.equals(titleLabel.getText(), newTitle)) {
			titleLabel.setText("PROUT" +newTitle);
	 ...
	 * (non-Javadoc)
	 * 
	 * @seeorg.eclipse.ui.internal.presentations.util.AbstractTabFolder#
	 * getPaneMenuLocation()
	 */
	 ...
	 * 
	 * @see
	 * org.eclipse.ui.internal.presentations.util.AbstractTabFolder#setActive
	 * (int)
	 */
...
//		updateColors();
	 ...
	 * 
	 * @see
	 * org.eclipse.ui.internal.presentations.util.AbstractTabFolder#setTabPosition
	 * (int)
	 */
	...
	public void setColors(MyDefaultTabFolderColors colors, int activationState,
	...
	public void updateColors() {		
		if (forcol!=null) {
			paneFolder.setSelectionForeground(forcol);
		}
		//paneFolder.getSelection().getControl().setBackground(p);
		...
		if (backcol != null) {
			...
			tabColor[0] = col;//Display.getDefault().getSystemColor(SWT.COLOR_BLACK);
			tabColor[1] = col;//Display.getDefault().getSystemColor(SWT.COLOR_BLACK);

		} else {
			tabColor[0] = Display.getDefault().getSystemColor(SWT.COLOR_BLACK);
			tabColor[1] = Display.getDefault().getSystemColor(SWT.COLOR_BLACK);
		}
		
		
		int[] pour = new int[1];
		pour[0] = 0;
		paneFolder.setSelectionBackground(tabColor, pour, false);
		
		
		/*
		MyDefaultTabFolderColors currentColors = shellActive ? 
	...
	private Color forcol;
	public void updateColors(Color backcol,Color forcol) {
		/*paneFolder.setSelectionForeground(Display.getDefault().getSystemColor(SWT.COLOR_GREEN));
		...
		tabColor[1] =p;
		tabColor[0] = Display.getDefault().getSystemColor(SWT.COLOR_GRAY);;
		
		
		int[] pour = new int[1];
		pour[0] = 90;
		
		paneFolder.setSelectionBackground(tabColor, pour, true);	*/
	 ...
	 * 
	 * @see
	 * org.eclipse.ui.internal.presentations.util.AbstractTabFolder#shellActive
	 * (boolean)
	 */
	 ...
	 * 
	 * @see
	 * org.eclipse.ui.internal.presentations.util.AbstractTabFolder#setVisible
	 * (boolean)
	 */
	 ...
	 * 
	 * @see
	 * org.eclipse.ui.internal.presentations.util.AbstractTabFolder#showMinMax
	 * (boolean)
	 */
