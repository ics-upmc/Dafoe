 ...
 *******************************************************************************/
package org.dafoe.application.presentations.wrappedTabs;
...
import org.dafoe.application.presentations.PresentationImages;
...
public class WrappedTabsPartPresentation extends StackPresentation {
	...
	public WrappedTabsPartPresentation(Composite parent, 
		...
		presentationControl.addPaintListener(new PaintListener() {
			public void paintControl(PaintEvent e) {
				...
				if (toto != null) {
					WorkbenchPartReference coco = (WorkbenchPartReference)toto.getPane().getPartReference();
		...
		contentDescription = new Label(contentDescriptionWrapper, SWT.FLAT);
	...
	public void addPart(IPresentablePart newPart, Object cookie) {
		...
		ToolItem toolItem = new ToolItem(toolBar, SWT.PUSH, position);
