 ...
 *
 * This is an object that contains data related to the m23_constraint_some_value_from table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="m23_constraint_some_value_from"
 */
public abstract class BaseSomeValueFromImpl  implements Serializable {
	 ...
	 */
	public BaseSomeValueFromImpl (java.lang.Integer _id) {
		this.setId(_id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof org.dafoe.framework.provider.hibernate.ontological.model.impl.base.BaseSomeValueFromImpl)) return false;
		else {
			org.dafoe.framework.provider.hibernate.ontological.model.impl.base.BaseSomeValueFromImpl mObj = (org.dafoe.framework.provider.hibernate.ontological.model.impl.base.BaseSomeValueFromImpl) obj;
