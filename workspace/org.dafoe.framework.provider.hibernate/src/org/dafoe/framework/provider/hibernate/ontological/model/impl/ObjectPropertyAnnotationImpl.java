...
import org.dafoe.framework.provider.hibernate.ontological.model.impl.base.BaseObjectPropertyAnnotationImpl;

public class ObjectPropertyAnnotationImpl extends BaseObjectPropertyAnnotationImpl implements IOntoAnnotation{


	
	public ObjectPropertyAnnotationImpl () {
		super();
		super.setItsProperty(new ObjectPropertyImpl());
