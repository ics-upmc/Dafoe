 ...
 *
 * This is an object that contains data related to the m23_constraint_less_than table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="m23_constraint_less_than"
 */
public abstract class BaseLessThanImpl  implements Serializable {

	public static String PROP_RELATED_PROPERTY = "RelatedProperty";
	public static String PROP_MATCHABLE_VALUE = "MatchableValue";
	...
	// fields
	private java.lang.Integer _matchableValue;
	 ...
	 */
	public BaseLessThanImpl (java.lang.Integer _id) {
		this.setId(_id);
		initialize();
	}
	...
	/**
	 * Return the value associated with the column: match_value
	 */
	public java.lang.Integer getMatchableValue () {
		return _matchableValue;
	}

	/**
	 * Set the value related to the column: match_value
	 * @param _matchableValue the match_value value
	 */
	public void setMatchableValue (java.lang.Integer _matchableValue) {
		this._matchableValue = _matchableValue;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof org.dafoe.framework.provider.hibernate.ontological.model.impl.base.BaseLessThanImpl)) return false;
		else {
			org.dafoe.framework.provider.hibernate.ontological.model.impl.base.BaseLessThanImpl mObj = (org.dafoe.framework.provider.hibernate.ontological.model.impl.base.BaseLessThanImpl) obj;
