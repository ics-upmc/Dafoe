 ...
 *
 * This is an object that contains data related to the m23_constraint_like table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="m23_constraint_like"
 */
public abstract class BaseLikeImpl  implements Serializable {
	 ...
	 */
	public BaseLikeImpl (java.lang.Integer _id) {
		this.setId(_id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof org.dafoe.framework.provider.hibernate.ontological.model.impl.base.BaseLikeImpl)) return false;
		else {
			org.dafoe.framework.provider.hibernate.ontological.model.impl.base.BaseLikeImpl mObj = (org.dafoe.framework.provider.hibernate.ontological.model.impl.base.BaseLikeImpl) obj;
