 ...
 *
 * This is an object that contains data related to the m23_constraint_high_than table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="m23_constraint_high_than"
 */
public abstract class BaseHighThanImpl  implements Serializable {
	 ...
	 */
	public BaseHighThanImpl (java.lang.Integer _id) {
		this.setId(_id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof org.dafoe.framework.provider.hibernate.ontological.model.impl.base.BaseHighThanImpl)) return false;
		else {
			org.dafoe.framework.provider.hibernate.ontological.model.impl.base.BaseHighThanImpl mObj = (org.dafoe.framework.provider.hibernate.ontological.model.impl.base.BaseHighThanImpl) obj;
