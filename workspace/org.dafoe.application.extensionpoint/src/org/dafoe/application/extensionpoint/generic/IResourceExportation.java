...
/**
 * The IResourceExportation Interface provide specification to complete by an export plug-in.
 * @author <a href="mailto:teguiak@gmail.com">Henry Valéry TEGUIAK</a>
 */
public interface IResourceExportation {

	/**
	 * Implements this method for create the user interface for contributor export plug-in must.
	 *
	...
	/**
	 * The contributor plug-in must Implements its process of exportation data here.
	 *
