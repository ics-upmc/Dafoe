package org.dafoe.plugin.load.corpus.syntex.main;
...
import org.dafoe.plugin.load.corpus.syntex.adaptater.Services;
...
/** SyntexLoaderResource for Dafoe.
			           ...
			           public void run(){
			     		  ...
			     		  if (dir != null) {
			     	          // Set the text box to the new selection
								...
								try {
									ImportSYNTEX imp = new ImportSYNTEX(new File(dir));
									imp.importData();
								} catch (IOException e) {
