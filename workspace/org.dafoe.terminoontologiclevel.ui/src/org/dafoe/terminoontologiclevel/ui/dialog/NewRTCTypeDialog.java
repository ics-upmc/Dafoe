 ...
 *
 */
public class NewRTCTypeDialog extends TitleAreaDialog {
	private Text text;
	 ...
	 * @param parentShell
	 */
	public NewRTCTypeDialog(Shell parentShell, String title) {
		super(parentShell);
		this.title = title;
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		setMessage(Messages.getString("NewRTCTypeDialog.0")); //$NON-NLS-1$
		setTitle(Messages.getString("NewRTCTypeDialog.1")); //$NON-NLS-1$
