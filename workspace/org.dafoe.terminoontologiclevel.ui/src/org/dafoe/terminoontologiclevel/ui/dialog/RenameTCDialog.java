 ...
 *
 */
public class RenameTCDialog extends TitleAreaDialog {
	private Text text;

	private static String TITLE = Messages.getString("RenameTCDialog.0"); //$NON-NLS-1$
	
	private static String MESSAGE = Messages.getString("RenameTCDialog.1"); //$NON-NLS-1$
	 ...
	 * @param parentShell
	 */
	public RenameTCDialog(Shell parentShell, String oldLabel) {
		super(parentShell);
		tcName = oldLabel;
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		zone_nom.setLayoutData(gd);
		{
			...
			LabelNom.setText(Messages.getString("RenameTCDialog.2")); //$NON-NLS-1$
